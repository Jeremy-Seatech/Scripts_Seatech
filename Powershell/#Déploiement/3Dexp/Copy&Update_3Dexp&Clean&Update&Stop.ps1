# Définir les variables =============================================> EDIT payload.zip
$url = "ftp://10.100.1.109:21/3Dexp.zip"
$destinationFolder = "C:\install"
$zipFile = "$destinationFolder\3Dexp.zip"
...
# Installation silencieuse ==================================================> EDIT setup.zip -silent
C:\install\1\setup.exe --silent c:\install\1\UserIntentions_CODE.xml
